...
def _response(invite, command: str | None = None) -> EnrollmentInviteResponse:
    return EnrollmentInviteResponse(
        ...
        expires_at=ensure_utc(invite.expires_at),
        downloaded_at=ensure_utc(invite.downloaded_at) if invite.downloaded_at else None,
        completed_at=ensure_utc(invite.completed_at) if invite.completed_at else None,
