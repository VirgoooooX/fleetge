...
export interface I18nSchema {
  ...
  "map.centerLocation": string;
  "map.configureCenter": string;
  "map.summaryAria": string;
  "map.totalHosts": string;
  "map.online": string;
  "map.issues": string;
  "map.offline": string;
  "map.unlocated": string;
  "map.unknown": string;
  "map.pending": string;
  "map.onlyIssues": string;
  "map.legendAria": string;
  "map.buildingTopology": string;
  "map.retry": string;
  "map.unlocatedKicker": string;
  "map.unlocatedNodes": string;
  "map.autoLocate": string;
  "map.awaitingCoordinates": string;
  "map.backToCluster": string;
  "map.close": string;
  "map.locationKicker": string;
  "map.setSharedLocation": string;
  "map.editHostLocation": string;
  "map.centerName": string;
  "map.city": string;
  "map.cityPlaceholder": string;
  "map.searchingCity": string;
  "map.latitude": string;
  "map.longitude": string;
  "map.ipLocationHint": string;
  "map.autoSuggest": string;
  "map.cancel": string;
  "map.saveLocation": string;
  "map.editSharedLocation": string;
  "map.hostsKicker": string;
  "map.hostsAtLocation": string;
  "map.containerCount": string;
  "map.editLocation": string;
  "map.openHostDetail": string;
  "map.runtimeKicker": string;
  "map.runtimeMetrics": string;
  "map.memory": string;
  "map.disk": string;
  "map.containers": string;
  "map.noRefreshRecord": string;
  "map.stacksKicker": string;
  "map.appStacks": string;
  "map.noStackSnapshot": string;
  "map.locationEditorKicker": string;
  "map.controlCenterKicker": string;
  "map.locationClusterKicker": string;
  "map.hostNodeKicker": string;
  "map.inspectorTitle": string;
  "map.configureCenterLocation": string;
  "map.hostCount": string;
  "map.onlineCount": string;
  "map.issueCount": string;
  "map.offlineCount": string;
  "map.unlocatedPosition": string;
  "map.locationNotSet": string;
  "map.cityMatched": string;
  "map.autoLocatedSuccess": string;
  "map.autoLocatedEmpty": string;
  "map.noLocatableHost": string;
  "map.suggestionReady": string;
  "map.suggestionUnavailable": string;
  "map.invalidCoordinates": string;
  "map.multiLocationSaved": string;
  "map.locationSaved": string;
  "map.locationSaveFailed": string;
  "map.globeAria": string;
  "map.controlsAria": string;
  "map.zoomIn": string;
  "map.zoomOut": string;
  "map.resetView": string;
  "map.fitHosts": string;
  "map.switchToPan": string;
  "map.switchToRotate": string;
  "map.currentRotate": string;
  "map.currentPan": string;
  "map.rotateHint": string;
  "map.panHint": string;
  "map.openCluster": string;
  "map.openHost": string;
  "map.equator": string;
  "map.chinaCenter": string;
  "map.viewCenter": string;
  "map.loadFailed": string;
  "shell.kicker": string;
  ...
  "stackGroup.appUnavailable": string;
  "stackGroup.moreActions": string;
